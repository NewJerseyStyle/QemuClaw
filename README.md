...
<!-- VM_DOWNLOAD:START -->
[Download OpenClaw VM Image (vm-headless-22249840088) — multiple split files, see release page](https://github.com/NewJerseyStyle/QemuClaw/releases/tag/vm-headless-22249840088)
<!-- VM_DOWNLOAD:END -->
