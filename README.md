...
| Platform | Download |
|----------|----------|
| Windows | [QemuClaw-Setup-1.0.4.exe](https://github.com/NewJerseyStyle/QemuClaw/releases/download/app-v1.0.4/QemuClaw-Setup-1.0.4.exe) (includes QEMU + 7-Zip) |
| macOS | [QemuClaw-1.0.4.dmg](https://github.com/NewJerseyStyle/QemuClaw/releases/download/app-v1.0.4/QemuClaw-1.0.4.dmg) |
| Linux | [QemuClaw-1.0.4-linux.AppImage](https://github.com/NewJerseyStyle/QemuClaw/releases/download/app-v1.0.4/QemuClaw-1.0.4-linux.AppImage) |
| Linux (deb) | [QemuClaw-1.0.4-linux.deb](https://github.com/NewJerseyStyle/QemuClaw/releases/download/app-v1.0.4/QemuClaw-1.0.4-linux.deb) |
<!-- APP_DOWNLOAD:END -->

### VM Image

<!-- VM_DOWNLOAD:START -->
[Download OpenClaw VM Image (vm-headless-29674062087)](https://github.com/NewJerseyStyle/QemuClaw/releases/download/vm-headless-29674062087/openclaw-headless-compressed.qcow2)
<!-- VM_DOWNLOAD:END -->
