...
<!-- VM_DOWNLOAD:START -->
[Download OpenClaw VM Image (vm-headless-22010727983) — multiple split files, see release page](https://github.com/NewJerseyStyle/QemuClaw/releases/tag/vm-headless-22010727983)
<!-- VM_DOWNLOAD:END -->
