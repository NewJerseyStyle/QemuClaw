...
<!-- VM_DOWNLOAD:START -->
[Download OpenClaw VM Image (vm-headless-22168094348) — multiple split files, see release page](https://github.com/NewJerseyStyle/QemuClaw/releases/tag/vm-headless-22168094348)
<!-- VM_DOWNLOAD:END -->
